...
")
  ...
  install(TARGETS ${TARGET_NAME}
    ARCHIVE DESTINATION ${CATKIN_PACKAGE_PYTHON_DESTINATION}/python3.6/${DIST_DIR}/${TARGET_NAME}
    LIBRARY DESTINATION ${CATKIN_PACKAGE_PYTHON_DESTINATION}/python3.6/${DIST_DIR}/${TARGET_NAME}
  )

  # Cause the library to be output in the correct directory.
  set(PYTHON_LIB_DIR ${CATKIN_DEVEL_PREFIX}/lib/python3.6/${DIST_DIR}/${PYTHON_PACKAGE_NAME})
